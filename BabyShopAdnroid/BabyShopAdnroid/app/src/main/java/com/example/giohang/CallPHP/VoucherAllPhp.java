...
public class VoucherAllPhp extends AsyncTask<String, List<VoucherItem>, List<VoucherItem>>
{
    private voucherall context;
    private RecyclerView recyclerView;
    private int flag = 0;
    public VoucherAllPhp(voucherall context, RecyclerView recyclerView, int flag)
    {
    ...
    protected List<VoucherItem> doInBackground(String... strings) {
        try
        {
            String link= MainLink.GlobalLink + "voucherall.php";
