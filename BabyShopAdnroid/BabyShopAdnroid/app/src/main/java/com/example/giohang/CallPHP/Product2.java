...
public class Product2 extends AsyncTask<String, List<ProductItem>, List<ProductItem>>
{
    private Home context;
    private RecyclerView recyclerView;
    private int flag = 0;
    public Product2(Home context, RecyclerView recyclerView, int flag)
    {
    ...
    protected List<ProductItem> doInBackground(String... strings) {
        try
        {
            String link= MainLink.GlobalLink + "productbestsale.php?best=2";
