...
public class OrderStatus extends AsyncTask<String, List<OrderItem>, List<OrderItem>>
{
    private int flag = 1;
    public OrderStatus(int flag)
    {
        this.flag = flag;
    }
    ...
    protected List<OrderItem> doInBackground(String... strings) {
        if (flag == 1)
        {
            try
            {
                ...
                String link= MainLink.GlobalLink + "orderstatus.php";
